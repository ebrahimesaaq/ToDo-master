...
import 'package:todo_master/view/screen/dash_board.dart';
...
import 'package:todo_master/view/screen/notification.dart';
import 'package:todo_master/view/screen/on_boarding.dart';
import 'package:todo_master/view/screen/profile.dart';
...
Map<String, Widget Function(BuildContext)> myRoutes = {
  ...
  AppRoutes.newTask: (context) => NewTask(),
  AppRoutes.newLargeTask: (context) => NewLargeTask(),
  ...
  AppRoutes.notification: (context) => const Notifications(),
